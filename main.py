...
def connection():
try:
con=sq.connect(host="localhost",user="root",password="",database
...
date_of_consultancy=input("enter date of consultancy of
appointment: ")
doctor_name=input("enter the name of the doctor you want to
consult? ")
f=doctor_name
cur.execute("insert into patients
values('{}',{},'{}','{}','{}','{}','{}')".format(pat_name,age,gender,address,c
ontact_no,date_of_consultancy,doctor_name))
print()
return doctor_name
con.commit()
except sq.Error as er:
...
con=connection()
cur=con.cursor()
cur.execute("select * from room_info where room_status like
'{}'".format('Not Booked'))
for i in cur.fetchall():
print(i)
except sq.Error as er:
...
global room_type
global room_no
number_days=int(input("enter the number of days you will be
needing the room for? "))
room_type=input("enter the room type you want to avail? ")
room_no=int(input("enter the room number: "))
cur.execute("select room_charges_per_day from room_info where
...
pathology_fees=b
x=str(b)
cur.execute("select fees from doctors where
doctor_name='{}'".format(doctor_name))
r=cur.fetchone()
doctor_fees=r[0]
m=str(doctor_fees)
total_amount=int(x)+int(m)
cur.execute("insert into bill_details_2
values({},'{}',{},'{}',{},{})".format(bill_no,pat_name,pathology_fees,doct
or_name,doctor_fees,total_amount))
print()
con.commit()
...
con=connection()
cur=con.cursor()
cur.execute("select * from bill_details_2 where
...
cur.execute("insert into bill_details_3
values({},'{}',{},'{}',{},'{}',{},{})".format(bill_no,pat_name,pathology_fees,
doctor_name,doctor_fees,room_type,room_charges,total_amount))
con.commit()
print("Thank you for coming to our hospital.Hope you have a
speedy recovery!")
except sq.Error as er:
print(er)
def bill_3():
...
number_days=int(input("enter the number of days you will be
needing the room for? "))
cur.execute("select room_charges_per_day from room_info
...
d=str(doctor_fees)
total_amount=int(d)+int(r)+int(p)
cur.execute("insert into bill_details_1
values({},'{}',{},'{}',{},'{}',{},{})".format(bill_no,pat_name,pathology_fees,
doctor_name,doctor_fees,room_type,room_charges,total_amount))
con.commit()
print("Thank you for coming to our hospital.Hope you have a
...
con=connection()
cur=con.cursor()
cur.execute("select * from bill_details_1 where
pat_name='{}'".format(pat_name))
for i in cur.fetchall():
print(" PRIYAMVADA EYE HOSPITAL
BILL")
...
con=connection()
cur=con.cursor()
cur.execute("select * from bill_details_3 where
pat_name='{}'".format(pat_name))
for i in cur.fetchall():
print(" PRIYAMVADA EYE HOSPITAL
BILL")
